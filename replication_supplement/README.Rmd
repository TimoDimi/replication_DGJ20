...
### Plots for Fig S1
```{r DGPs_DataDriven, message=FALSE, warning=FALSE, fig.width = 16, fig.height = 4, fig.keep = 1:3}
source("DGPs_DataDriven.R", local = knitr::knit_global())
```

```{r DGPs_DataDriven2, fig.width = 12, fig.height = 8}
...
```{r Instabilities_QBinning, message = FALSE, fig.width = 16, fig.height = 16}
...
```{r sim_Coverage_Bands_DataDriven, message = FALSE, fig.width = 14, fig.height = 14}
...
```{r sim_Efficiency_DataDriven, message = FALSE, fig.width = c(12, 12, 12, 15), fig.height = 15}
...
```{r discrimination_diagrams, message = FALSE, fig.width = 12, fig.height = 12}
